...
import com.example.quizapp4.Model.TestModel;
import com.example.quizapp4.R;
import com.example.quizapp4.StartTestActivity;
...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(int pos, int progres) {
            testNo.setText("Test No: " + String.valueOf(pos + 1));
            topScore.setText(String.valueOf(progres) + "%");
